       ...
       // Método para listar usuários
        ...
        public void PesquisaUsuario()
        {
            ...
            try
            {
                ...
                cone.Cmd = new MySqlCommand("SELECT u.id_usuario, u.nome, u.login, u.senha, p.tipo_pessoa FROM usuario u join pessoa p ON p.id_pessoa = u.tipo_pessoa WHERE nome_usuario LIKE @usuario order by nome_usuario", cone.Con);

                cone.Cmd.Parameters.Add("@usuario", MySqlDbType.VarChar).Value = "%" + txt_pesquisar.Text + "%";
